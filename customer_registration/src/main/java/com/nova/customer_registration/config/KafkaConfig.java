...
public class KafkaConfig {
    ...
    @Bean
    public ConsumerFactory<String, CustomerValidatedEvent> consumerFactory() {
        Map<String, Object> props = new HashMap<>();
        ...
        props.put("sasl.jaas.config",
                PlainLoginModule.class.getName() + " required " +
                        "username=\"" + saslUsername + "\" " +
                        "password=\"" + saslPassword + "\";");
        JsonDeserializer<CustomerValidatedEvent> deserializer = new JsonDeserializer<>(CustomerValidatedEvent.class);
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, CustomerValidatedEvent> kafkaListenerContainerFactory() {
        var factory = new ConcurrentKafkaListenerContainerFactory<String, CustomerValidatedEvent>();
